            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Detail Data Pinjaman Anggota</h6>
                </div>
                <?php
                if(isset($_GET['notif'])){
                 if($_GET['notif']=="konfirmasi-gagal"){
                  echo "<div class='alert alert-danger alert-dismissible'>
                        <a style='text-decoration:none;' href='dashboard_manager.php?p=detail_pinjaman_anggota&id=".$id."' type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</a>
                       ...
                       <div class="col-lg-4">Status Pinjaman</div>
                        ...
                        <div class="box-footer">
                          <?php if ($data['status_pinjaman']==""){
                            echo "<a href='proses_konfirmasi_pengajuan.php?id=".$data['id_pinjaman']."' class='btn btn-primary'><i class='fa fa-check'></i> Konfirmasi Pengajuan</a>
                              <a href='dashboard_manager.php?p=data_pinjaman_anggota' class='btn btn-default'><i class='fa fa-warning'></i> Tutup</a>";
                           }else{
                           echo"<a href='dashboard_manager.php?p=data_pinjaman_anggota' class='btn btn-default'><i class='fa fa-warning'></i> Tutup</a>";
                            }
                           ?>
                       </div>
                      </tr>
