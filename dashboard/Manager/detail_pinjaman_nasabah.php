                ...
                if(isset($_GET['notif'])){
                 if($_GET['notif']=="konfirmasi-gagal"){
                  echo "<div class='alert alert-danger alert-dismissible'>
                        <a style='text-decoration:none;' href='dashboard_manager.php?p=detail_pinjaman_nasabah&id=".$id."' type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</a>
                        ...
                        <div class="box-footer">
                          <?php if ($data['status_pinjaman']==""){
                            echo "<a href='proses_konfirmasi_pengajuan_nasabah.php?id=".$data['id_pinjaman']."' class='btn btn-primary'><i class='fa fa-check'></i> Konfirmasi Pengajuan</a>
                              <a href='dashboard_manager.php?p=data_pinjaman_nasabah' class='btn btn-default'><i class='fa fa-warning'></i> Tutup</a>";
                           }else{
                           echo"<a href='dashboard_manager.php?p=data_pinjaman_nasabah' class='btn btn-default'><i class='fa fa-warning'></i> Tutup</a>";
                            }
                           ?>
                       </div>
                      </tr>
