            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Tabel Data Pembayaran Pinjaman Nasabah</h6>
                </div>
                <div class="card-body">
                        ...
                        <td>
                          <table class="table table-bordered" style="font-size: 12px;">
                            ...
                            <tbody>
                              ...
                              include"koneksi.php";
                              $no_a=1;
                              $query_a="SELECT * FROM tbl_pembayaran_pinjaman_nasabah WHERE id_nasabah='".$data['id_nasabah']."'";
