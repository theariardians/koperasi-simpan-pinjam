 <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          ...
          <a href="dashboard.php?p=input_pinjaman_nasabah" class="btn btn-primary" style="margin-bottom: 3px; "><i class="fa fa-edit"></i> INPUT PENGAJUAN PINJAMAN</a>
          <a href="dashboard.php?p=data_pembayaran_pinjaman_nasabah" class="btn btn-primary" style="margin-bottom: 3px; "><i class="fa fa-eye"></i>DATA PEMBAYARAN</a>
          <a href="dashboard.php?p=data_tunggakan_nasabah" class="btn btn-warning" style="margin-bottom: 3px; "><i class="fa fa-eye"></i>DATA SISA ANGSURAN</a>
          <div class="row mb-12">
                    ...
                    <tbody>
                      ...
                      $data_nasabah=mysqli_fetch_array($sql_nasabah) ?>
                        ...
                        <td><?php echo $data['status'];?></td>
                         <td><a href="dashboard.php?p=detail_pinjaman_nasabah&id=<?php echo $data['id_pinjaman'];?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                          <?php
                         if($data['jumlah_pinjaman']==0){
                         echo "";
                         }else{
                          
                          echo"<a href='dashboard.php?p=input_pembayaran_pinjaman_nasabah&id=".$data['id_pinjaman']."' class='btn btn-warning btn-sm' ><i class='fa fa-edit'></i></a>";
                         }
                          ?>
                         </td>
                      </tr>
