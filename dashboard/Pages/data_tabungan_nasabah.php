 <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          ...
          <a href="dashboard.php?p=input_tabungan_nasabah" class="btn btn-primary" style="margin-bottom: 3px; "><i class="fa fa-edit"></i> INPUT TABUNGAN</a>
          <a href="dashboard.php?p=input_penarikan_tabungan_nasabah" class="btn btn-primary" style="margin-bottom: 3px; "><i class="fa fa-edit"></i> INPUT PENARIKAN TABUNGAN</a>
          <a href="dashboard.php?p=rekaptulasi_tabungan_nasabah" class="btn btn-warning" style="margin-bottom: 3px; "><i class="fa fa-eye"></i>Lihat Rekaptulasi Tabungan</a>
          <div class="row mb-12">
                          ...
                          <table class="table table-bordered" style="font-size: 12px;">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a href="dashboard.php?p=update_tabungan_nasabah&id=<?php echo $data_a['id_tabungan_n'];?>" class="btn btn-danger btn-sm"><i class="fa fa-edit"></i></a></td>
                              </tr>
                              <?php $no_a++;}?>
                            </tbody>
                          </table>
