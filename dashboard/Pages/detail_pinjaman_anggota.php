            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Detail Data Pengajuan Pinjaman Anggota</h6>
                </div>
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      <div class="row">
                       <div class="col-lg-4">Status Pinjaman</div>
                        ...
                        <td><a href="dashboard.php?p=data_pinjaman_anggota" class="btn btn-warning"><i class="fa fa-close"></i> Tutup</a></td>
                      </tr>
                    </tbody> 
                  </table>
                </div>
