 <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h4 mb-0 text-gray-800">Detail Pengajuan Pinjaman Nasabah</h2>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Detail Pengajuan Pinjaman Nasabah</li>
            </ol>
          </div>
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Detail Data Pengajuan Pinjaman Nasabah</h6>
                </div>
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      <div class="row">
                       <div class="col-lg-4">Status Pinjaman</div>
                        ...
                        <td><a href="dashboard.php?p=data_pinjaman_nasabah" class="btn btn-warning"><i class="fa fa-close"></i> Tutup</a></td>
                      </tr>
                    </tbody> 
                  </table>
                </div>
