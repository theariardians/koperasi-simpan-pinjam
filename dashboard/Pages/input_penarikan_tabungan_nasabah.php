          ...
          <div class="row mb-12">
            ...
            <div class="col-xl-12 col-md-6 mb-4">
               <div class="card mb-4">
                ...
                <h6 class="m-0 font-weight-bold text-primary">Form Input Penarikan</h6>
                </div>
                <div class="card-body">
                  <form method="post" action="proses_simpan_penarikan_nasabah.php" enctype="multipart/form-data">
