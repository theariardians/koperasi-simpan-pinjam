                  ...
                  <table class="table align-items-center table-bordered" id="dataTableHover">
                    ...
                    <?php
                     ...
                     $query_user="SELECT COALESCE(tahun, 'TOTAL') AS tahun, 
                                         COALESCE(id_nasabah, 'SUB TOTAL') AS id_nasabah,
                                         SUM(ttl_tabungan_nasabah) AS ttl_tabungan_nasabah, SUM(jml_bunga) AS jml_bunga 
                                  FROM `tbl_rekap_tabungan_nasabah` 
                                  GROUP BY `tahun`, `id_nasabah` WITH ROLLUP";
