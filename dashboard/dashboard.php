...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=data_anggota">
          <i class="fas fa-fw fa-users"></i>
          <span>Data Anggota</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=data_nasabah">
          <i class="fas fa-fw fa-users"></i>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="dashboard.php?p=data_simpanan_anggota">Simpanan</a>
            <a class="collapse-item" href="dashboard.php?p=halaman_awal_tabungan">Tabungan</a>
          </div>
          </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="dashboard.php?p=data_penarikan">
          <i class="fas fa-fw fa-book"></i>
          <span>Data Penarikan</span></a>
      </li>
      <li class="nav-item">
        ...
        <div id="collapsePage" class="collapse" aria-labelledby="headingTable"
          data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="dashboard.php?p=data_pinjaman_anggota"> Pinjaman Anggota</a>
            <a class="collapse-item" href="dashboard.php?p=data_pinjaman_nasabah">Pinjaman Nasabah</a>
          </div>
        </div>
      </li>
       <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="dashboard.php?p=laporan_simpanan_anggota">Laporan Simpanan Anggota</a>
            <a class="collapse-item" href="dashboard.php?p=laporan_tabungan">Laporan Tabungan</a>
