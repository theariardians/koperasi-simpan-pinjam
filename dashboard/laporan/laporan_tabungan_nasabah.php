...
$pdf->SetX(1.6);
$pdf->SetFont('Times','i',10);
$pdf->MultiCell(22.5,0.6,"Laporan Tabungan Nasabah Periode: ".$periode."/ Tahun: ".$tahun,0,'L'); 
...
$no=1;
$sql="SELECT * FROM tbl_tabungan_nasabah WHERE periode='$periode' AND tahun='$tahun'";
...
$pdf->ln(1);
$pdf->SetFont('Times','i',10);
$pdf->Cell(22.5,0.7,"Hasil Rekapitulasi Tabungan Nasabah Periode: ".$periode." Tahun: ".$tahun,0,0,'L');
$pdf->ln(1);
$no=1;
$pdf->SetFont('Times','B',8);
$pdf->Cell(1, 0.6, 'No', 1, 0, 'C');
...
$sql_x="SELECT * FROM tbl_rekap_tabungan_nasabah WHERE tahun = '$tahun'";
...
$order="SELECT * FROM tbl_rekap_tabungan_nasabah WHERE tahun='$tahun'";
