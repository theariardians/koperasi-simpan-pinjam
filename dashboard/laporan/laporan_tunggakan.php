...
$no=1;
$sql="SELECT * FROM tbl_pembayaran_pinjaman WHERE periode='$periode' AND tahun='$tahun'";
...
$order="SELECT * FROM tbl_pembayaran_pinjaman WHERE periode='$periode' AND tahun='$tahun'";
