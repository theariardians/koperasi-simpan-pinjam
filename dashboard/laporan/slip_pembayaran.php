...
$sql="SELECT * FROM tbl_pembayaran_pinjaman WHERE periode='$periode' AND tahun='$tahun' AND id_anggota='$anggota'";
$tampil=mysqli_query($connect, $sql);
$lihat=mysqli_fetch_array($tampil);
$bayar=$lihat['angsuran_pokok']+$lihat['angsuran_bunga'];
$sql1="SELECT * FROM tbl_anggota WHERE id_anggota='$anggota'";
...
$pdf->Cell(11,0.5,"Jalan KH. Ahmad Dahlan, Desa Bhakti Sejahtera",0,0,'L');
$pdf->Cell(3,0.5,"Periode/Tahun",0,0,'L');
$pdf->Cell(1,0.5,":",0,0,'L');
$pdf->Cell(5,0.5,$periode."/".$tahun,0,1,'L');
...
$pdf->SetFont('Times','i',10);
    ...
    $pdf->Cell(1, 0.6,":",0, 0, 'C');
    $pdf->Cell(10, 0.6, $lihat['id_anggota']."-".$lihat1['nama_anggota'],0, 1, 'L');
    ...
    $pdf->Cell(20.5,0.7,"Desa Pikat, ".date("D-d/m/Y"),0,1,'L');
    ...
    $pdf->SetX(15);
    $pdf->SetFont('Times','',10);
    $pdf->Cell(10,2,"Desa Pikat, ".date("d/m/Y"),0,'R');
    $pdf->SetFont('Times','',10);
    $pdf->SetX(4);            
    $pdf->Cell(10,8,$konten,0,'L');
    $pdf->SetX(16);
    $pdf->SetFont('Times','',10);
    $pdf->Cell(10,8,$lihat1['nama_anggota'],0,'R');
