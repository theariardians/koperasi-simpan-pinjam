...
if ($jp > $data_pinjaman['jumlah_pinjaman']){
    ...
    document.location.href='dashboard.php?p=data_pinjaman_nasabah&id=".$id."'</script>\n";
      ...
      $query1 = "INSERT INTO `tbl_pembayaran_pinjaman_nasabah` (`id_pembayaran`, `id_nasabah`, `periode`, `tahun`, `tgl_pembayaran`, `jumlah_pinjaman`, `jenis_bunga`, `bunga`, `jangka_waktu`, `angsuran_k`, `sisa_angsuran`, `angsuran_pokok`, `angsuran_bunga`, `total_angsuran`, `total_tunggakan`) VALUES ('$idpembayaran', '$np', '$bulan', '$tahun', '$tp', '$jp', '$jb', '$bunga', '$jw', '$ak', '$sa', '$ap', '$ab', '$ta', '$tt')";
