...
$query_penarikan="SELECT * FROM tbl_rekap_tabungan_nasabah WHERE id_nasabah='$nasabah'";
...
if ($jp>$data_penarikan['ttl_tabungan_nasabah']){
    ...
    document.location.href='dashboard.php?p=input_penarikan_tabungan_nasabah'</script>\n";
}else{
         
         $query_a="INSERT INTO `tbl_penarikan` (`id_penarikan`, `penarik`, `periode`, `tahun`, `tgl_penarikan`, `jml_penarikan`) VALUES ('$idpenarikan', '$nasabah', '$bulan', '$tahun', '$tgl', '$jp')";
